...
**Режим выгрузки в Excel (по запросу «Топ-10 муниципальных образований с наиболее длинными наименованиями»):**
![картинка 4](https://github.com/user-attachments/assets/55f3ceb7-de37-4b52-bb5d-256631d817fb)

**Режим отчета (по запросу «В каких муниципальных образованиях лучший доступ к рынку»):**
